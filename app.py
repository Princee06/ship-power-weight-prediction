...
def run_sanity_checks(l, b, d, dr, s, t):
    ...
    if l > 450: errors.append("LOA exceeds 450m.")
    if t == "Tug" and l > 100: errors.append("Tugs rarely exceed 100m.")
    if t == "Bulk Carrier" and s > 18: warnings.append("Speed high for Bulk Carrier.")
    if b > 0:
        lb = l/b
        if lb < 3 or lb > 12:
